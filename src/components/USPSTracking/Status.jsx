        ...
        <Grid container item xs={12} className={classes.statusContainer}>
          ...
          >
            <Typography className={classes.statusOtherLabel} align="center">
              {estimatedDelivery.type || 'Estimated'} Delivery
            </Typography>
            <Typography className={classes.statusOtherVal} align="center">
              {renderDate(estimatedDelivery.timestamp, STATUS_DATE_FORMAT)}
            </Typography>
          </Grid>
          ...
          >
            ...
            <Typography
              className={classes.statusOtherVal}
              align="center"
              dangerouslySetInnerHTML={{ __html: renderValue(service) }} // USPS likes to include trademark as html in their service name
            />
          </Grid>
