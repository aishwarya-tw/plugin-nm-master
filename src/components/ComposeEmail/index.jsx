...
class ComposeEmail extends Component {
  ...
  checkSkillAvailability = (skills) => { 
    ...
    skills.map(skill=>{      
      if((skill === 'NM Outbound Email' && brand === 'Neiman Marcus') ||
         ( skill === 'BG Outbound Email' && brand === 'Bergdorf Goodman' )||(skill === 'HC Outbound Email' && brand === 'Horchow')){          
  ...
  handleSend = (filters) => {
    ...
    console.log('email inputs handle Send:',email);
  ...
  render() {
    let hasSkill = manager &&
                   ...
                   this.checkSkillAvailability(manager.workerClient.attributes.routing.skills) : false;
